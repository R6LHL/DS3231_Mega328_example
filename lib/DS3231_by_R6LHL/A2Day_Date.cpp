...
void DS3231_RTC::Alarm2Day_Date::set_Day(uint8_t day)
{
    uint8_t raw_byte = Register::get_RAW_Byte();
...
void DS3231_RTC::Alarm2Day_Date::set_Date(uint8_t date)
{
    uint8_t raw_byte = Register::get_RAW_Byte();
...
void DS3231_RTC::Alarm2Day_Date::set_day_alarm(void)
{
    uint8_t raw_byte = Register::get_RAW_Byte();
...
void DS3231_RTC::Alarm2Day_Date::set_date_alarm(void)
{
    uint8_t raw_byte = Register::get_RAW_Byte();
    raw_byte |= (1<<Register::b_dy_dt);
    Register::send_Byte(raw_byte);
...
void DS3231_RTC::Alarm2Day_Date::set_a2m4(void)
{
    uint8_t raw_byte = Register::get_RAW_Byte();
    raw_byte |= (1<<Register::b_a2m4);
    Register::send_Byte(raw_byte);
}

void DS3231_RTC::Alarm2Day_Date::clear_a2m4(void)
{
    uint8_t raw_byte = Register::get_RAW_Byte();
    raw_byte &= ~(1<<Register::b_a2m4);
    Register::send_Byte(raw_byte);
