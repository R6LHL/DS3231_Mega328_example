...
uint8_t DS3231_RTC::Alarm1Hours::get_Value()
{
    ...
    Register::is_a1m3_set = raw_byte & Register::a1m3_mask;
...
void DS3231_RTC::Alarm1Hours::set_Value(uint8_t h)
{
    if (get_c12_24() == 0)
    {
...
void DS3231_RTC::Alarm1Hours::set_12_mode()
{
...
void DS3231_RTC::Alarm1Hours::set_24_mode()
{
    uint8_t byte_ = Register::get_RAW_Byte();
    byte_ &= ~(1<<Register::b_c12_24);
    Register::send_Byte(byte_);
...
void DS3231_RTC::Alarm1Hours::set_am(void)
{
    uint8_t byte_ = Register::get_RAW_Byte();
...
void DS3231_RTC::Alarm1Hours::set_pm(void)
{
    uint8_t byte_ = Register::get_RAW_Byte();
    byte_ |= (1<<Register::b_am_pm);
    Register::send_Byte(byte_);
...
void DS3231_RTC::Alarm1Hours::set_a1m3(void)
{
    uint8_t byte_ = Register::get_RAW_Byte();
    byte_ |= (1<<Register::b_a1m3);
    Register::send_Byte(byte_);
}

void DS3231_RTC::Alarm1Hours::clear_a1m3(void)
{
    uint8_t byte_ = Register::get_RAW_Byte();
    byte_ &= ~(1<<Register::b_a1m3);
    Register::send_Byte(byte_);
