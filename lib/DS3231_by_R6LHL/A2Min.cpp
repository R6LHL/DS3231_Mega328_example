...
uint8_t DS3231_RTC::Alarm2Minutes::get_Value()
{
    ...
    Register::is_a2m2_set = raw_byte & Register::a2m2_mask;

    mins = raw_byte & Register::mins_mask;
    return mins_10 + mins;
}

void DS3231_RTC::Alarm2Minutes::set_Value(uint8_t m)
{
...
void DS3231_RTC::Alarm2Minutes::set_a2m2(void)
{
    uint8_t raw_byte = Register::get_RAW_Byte();
    raw_byte |= (1 << Register::b_a2m2);
    Register::send_Byte(raw_byte);
}

void DS3231_RTC::Alarm2Minutes::clear_a2m2(void)
{
    uint8_t raw_byte = Register::get_RAW_Byte();
    raw_byte &= ~(1 << Register::b_a2m2);
    Register::send_Byte(raw_byte);
